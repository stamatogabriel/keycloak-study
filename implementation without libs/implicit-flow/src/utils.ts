...
export function makeLoginUrl() {
  ...
  return `http://localhost:8080/realms/full-cycle/protocol/openid-connect/auth?${loginUrlParams.toString()}`;
}
...
export function makeLogoutUrl() {
  ...
  return `http://localhost:8080/realms/full-cycle/protocol/openid-connect/logout?${logoutParams.toString()}`;
}
